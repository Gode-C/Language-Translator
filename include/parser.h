...
/*!
     Parser Class built with token type and scanner,
     including methods which are sperated by
     nonterminals, exprssions
     and 4 helper functions which match the input and tokens
 */
